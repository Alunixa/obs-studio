...
# Child helper builds must use the same explicitly selected release version,
# rather than deriving one from an unrelated archive/custom Git tag.
set(_obs_child_version_args)
if(DEFINED OBS_VERSION_OVERRIDE)
  list(APPEND _obs_child_version_args "-DOBS_VERSION_OVERRIDE:STRING=${OBS_VERSION_OVERRIDE}")
endif()
